...
PKG_SOURCES	=  tgumbo.c tclgumbo.c generic/attribute.c generic/char_ref.c generic/error.c generic/parser.c generic/string_buffer.c generic/tag.c generic/string_piece.c generic/tokenizer.c generic/utf8.c generic/util.c generic/vector.c
PKG_OBJECTS	=  tgumbo.o tclgumbo.o attribute.o char_ref.o error.o parser.o string_buffer.o tag.o string_piece.o tokenizer.o utf8.o util.o vector.o
...
PKG_LIB_FILE	= libtclgumbo0.2.8.so
PKG_LIB_FILE8	= libtclgumbo0.2.8.so
PKG_LIB_FILE9	= libtcl9tclgumbo0.2.8.so
PKG_STUB_LIB_FILE = libtclgumbostub0.2.8.a
...
top_builddir	= /home/danilo/Public/tclgumbo
...
INCLUDES	=  -I./generic -I"/usr/include" -I.
#INCLUDES	=  -I./generic -I"/usr/include" @TK_INCLUDES@ @TK_XINCLUDES@
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"tclgumbo\" -DPACKAGE_TARNAME=\"tclgumbo\" -DPACKAGE_VERSION=\"0.2.8\" -DPACKAGE_STRING=\"tclgumbo\ 0.2.8\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclgumbo=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"tclgumbo\" -DPACKAGE_TARNAME=\"tclgumbo\" -DPACKAGE_VERSION=\"0.2.8\" -DPACKAGE_STRING=\"tclgumbo\ 0.2.8\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclgumbo=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
